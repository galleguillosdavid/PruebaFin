...
class SuperHeroesRepository(private val superHeroesDao: SuperHeroesDao) {
    ...
    fun getDataFromServerWithOutCoroutines() {
        ...
        call.enqueue(object : Callback<Gen3Item> {
            override fun onResponse(
                    call: Call<Gen3Item>,
                    response: Response<Gen3Item>
            ) {
                when (response.code()) {
            ...
            override fun onFailure(call: Call<Gen3Item>, t: Throwable) {
                Log.e("error", t.message.toString())
            }
        })
    }

    fun converters(listFromNetwork: List<Gen3Item>): List<SuperHeroesEntity> {
